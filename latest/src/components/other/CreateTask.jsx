...
const CreateTask = () => {
  ...
  const createTaskHandler = () => {
    toast.success(`Task successfully assigned to ${asignTo}!`, {
      position: 'top-right',
      autoClose: 3000,
      ...
      pauseOnHover: true,
      draggable: true,
      style: { backgroundColor: '#4CAF50', color: '#FFFFFF' }, // Custom background and text color
    });
  };
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className='flex w-full flex-wrap item-start justify-between'>
        ...
        <div className='w-2/5 flex flex-col items-start'>
          ...
          <button onClick={createTaskHandler} className='bg-emerald-500 py-2 md:px-5 md:py-3 hover:bg-emerald-600 px-2 rounded text-sm mt-4 w-full'>Create Task</button>
